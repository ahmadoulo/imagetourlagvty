...
import { Activity, Database, Server, Clock, HardDrive, Cpu, ShieldCheck } from "lucide-react";
import os from "os";
...
export default async function AdminHealthPage() {
  ...
  return (
    <div className="p-8 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-6 text-green-600 flex items-start gap-4">
        <ShieldCheck className="w-6 h-6 shrink-0 mt-0.5" />
        <div>
          <h3 className="font-bold mb-1">System is Healthy</h3>
          <p className="text-sm">All core services are responding normally. No active alerts.</p>
        </div>
      </div>
    </div>
  );
